...
//----------------------------------------------------------------------------------------------------
  ...
  this.bgColor = "#FDF9C6";             // background color
  this.textFont = "Arial";           // text font family
  this.textSize = 11;                   // text font size (pixels)
  this.textColor = "#000000";           // text color
  this.border = "0px dashed #000000";   // border (CSS spec: size style color, e.g. "1px solid #000000")
  this.opacity = 80;                    // opacity (0 - 100); not supported by all browsers
  this.cursorDistance = 2;              // distance from mouse cursor (pixels)
